 ...
 *
 */
public class DSplitButton extends JButton {
    ...
    public DSplitButton(Action defaultAction) {
    	this();
    	setAction(defaultAction);
    }
    
    public DSplitButton(Action defaultAction, JPopupMenu popup) {
    	this();
    	setAction(defaultAction);
    	setPopupMenu(popup);
    }
    
    public DSplitButton(Action defaultAction, Action... actions) {
    	this();
    	setAction(defaultAction);
    ...
    public DSplitButton(String text) {
    	this();
    	setText(text);
    }
    
    public DSplitButton(String text, Icon icon) {
    	this();
    	setText(text);
    	setIcon(icon);
    }
    
    public DSplitButton(String text, JPopupMenu popup) {
    	this();
    	setText(text);
    	setPopupMenu(popup);
    }
    
    public DSplitButton(String text, Icon icon, JPopupMenu popup) {
    	this();
    	setText(text);
    	setIcon(icon);
    	setPopupMenu(popup);
	 ...
	 * @return
	 */
	public static DSplitButton createToolBarButton(Action defaultAction, Action... actions) {
	    DSplitButton btn = new DSplitButton(defaultAction, actions);
	 ...
	 * @return
	 */
	public static DSplitButton createToolBarButton(String text, Icon icon, JPopupMenu popupMenu) {
	    DSplitButton btn = new DSplitButton(text, icon);
