...
/**
 * From
 * https://stackoverflow.com/questions/7569929/jformattedtextfield-to-format-percent-numbers
 * @author Roland Schneider
 */
public class DPercentageSpinner extends JComponent {
    ...
    public int getPercent() {
        return (int) Math.round(((Double) spinner.getValue() * 100));
    }

    public void setPercent(int percent) {
        spinner.setValue(percent/100d);
    }
